...
// .wrangler/tmp/pages-S32DWW/bundledWorker-0.23488468039675658.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, n, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let r of re(t)) !oe.call(e, r) && r !== n && H(e, r, { get: /* @__PURE__ */ __name2(() => t[r], "get"), enumerable: !(s = ae(t, r)) || s.enumerable });
  return e;
}, "ce");
var F = /* @__PURE__ */ __name2((e, t, n) => (n = e != null ? ne(ie(e)) : {}, ce(t || !e || !e.__esModule ? H(n, "default", { value: e, enumerable: true }) : n, e)), "F");
var g;
var u = j(() => {
  g = { collectedLocales: [] };
});
...
function je() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, n) => e.has(n) ? e.get(n) : Reflect.get(globalThis, n), "get"), set: /* @__PURE__ */ __name2((t, n, s) => Ne.has(n) ? Reflect.set(globalThis, n, s) : (e.set(n, s), true), "set") });
}
__name(je, "je");
__name2(je, "je");
...
// .wrangler/tmp/pages-S32DWW/ui4ydnh0un.js
...
// .wrangler/tmp/bundle-FajVuv/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-FajVuv/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=ui4ydnh0un.js.map
