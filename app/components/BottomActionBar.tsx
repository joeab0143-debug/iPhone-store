...
export default function BottomActionBar() {
  ...
  return (
    <>
      <nav className="no-print fixed bottom-0 left-0 right-0 z-40 mx-auto max-w-md border-t border-border-soft bg-bg-elevated/95 backdrop-blur-md px-3 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-2">
